...
if __name__ == "__main__":
    ...
    """
    y_real_alex = torch.load(r'.\classifier_output\classifier-head-alexNet\labels.pt')
    y_pred_alex = torch.load(r'.\classifier_output\classifier-head-alexNet\predictions.pt')
    
    y_real_google = torch.load(r'.\classifier_output\classifier-head-googleNet\labels.pt')
    y_pred_google = torch.load(r'.\classifier_output\classifier-head-googleNet\predictions.pt')
    
    y_real_mobilenet = torch.load(r'.\classifier_output\classifier-head-mobileNet\labels.pt')
    y_pred_mobilenet = torch.load(r'.\classifier_output\classifier-head-mobileNet\predictions.pt')
    
    y_real_vgg = torch.load(r'.\classifier_output\classifier-head-vgg\labels.pt')
    y_pred_vgg = torch.load(r'.\classifier_output\classifier-head-vgg\predictions.pt')
    
    y_real_resnet = torch.load(r'.\classifier_output\classifier-head-resnet34\labels.pt')
    y_pred_resnet = torch.load(r'.\classifier_output\classifier-head-resnet34\predictions.pt')
