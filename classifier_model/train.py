...
from dataset import *
from my_utils import show, make_dir, get_logger, load_checkpoint
...
def train(
    ...
    for epoch_idx in range(start_epoch, epochs):
        ...
        with torch.no_grad():
            ...
            f1 = get_accuracy(labels_tensor, predictions_tensor)
            logger.info("f1: %f" % f1)
            if draw_img:
                labels_tensor = torch.zeros(len(labels_list), *torch.tensor(labels_list[0]).shape)
                for i in range(len(labels_list)):
...
if __name__ == '__main__':
    # ========================= test over different models ========================= #
    train(
        output_dir=r'.\classifier_output',
        session_name='classifier-head-alexnet-b8-test',
        dataset_dir=r'.\head_classification\_train',
        val_dataset_dir=r'.\head_classification\_validation',
        img_size=(120, 120),
    ...
    train(
        output_dir=r'.\classifier_output',
        session_name='classifier-head-vgg-b8-test',
        dataset_dir=r'.\head_classification\_train',
        val_dataset_dir=r'.\head_classification\_validation',
        img_size=(120, 120),
        class_list=HEAD_MOTIONS,
    ...
    train(
        output_dir=r'.\classifier_output',
        session_name='classifier-head-googleNet-b8-test',
        dataset_dir=r'.\head_classification\_train',
        val_dataset_dir=r'.\head_classification\_validation',
        img_size=(120, 120),
        class_list=HEAD_MOTIONS,
    ...
    train(
        output_dir=r'.\classifier_output',
        session_name='classifier-head-resNet-b8-test',
        dataset_dir=r'.\head_classification\_train',
        val_dataset_dir=r'.\head_classification\_validation',
        img_size=(120, 120),
        class_list=HEAD_MOTIONS,
    ...
    train(
        output_dir=r'.\classifier_output',
        session_name='classifier-head-mobileNet-b8-test',
        dataset_dir=r'.\head_classification\_train',
        val_dataset_dir=r'.\head_classification\_validation',
        img_size=(120, 120),
        class_list=HEAD_MOTIONS,
    ...
    # ========================= test over different batch sizes ========================= #
    train(
        output_dir=r'.\classifier_output',
        session_name='classifier-head-mobileNet-b8-test',
        dataset_dir=r'.\head_classification\_train',
    ...
    train(
        output_dir=r'.\classifier_output',
        session_name='classifier-head-mobileNet-b4-test',
        dataset_dir=r'.\head_classification\_train',
        val_dataset_dir=r'.\head_classification\_validation',
        img_size=(120, 120),
        class_list=HEAD_MOTIONS,
    ...
    train(
        output_dir=r'.\classifier_output',
        session_name='classifier-head-mobileNet-b2-test',
        dataset_dir=r'.\head_classification\_train',
        val_dataset_dir=r'.\head_classification\_validation',
        img_size=(120, 120),
        class_list=HEAD_MOTIONS,
