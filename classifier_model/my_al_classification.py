...
import shutil
import numpy as np
from my_utils import load_model_cancel_parallel
import pickle
...
if __name__ == "__main__":
    ...
    """
    dataset_dir = r'.\_unlabeled_dataset'
    output_dataset_dir = r'.\_need_labeled'
    filename = r'.\classifier-head-mobileNet\saved_checkpoints\model_param_199.pkl'
    labeled_number = 1000
